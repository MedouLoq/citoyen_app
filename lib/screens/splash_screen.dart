            ...
            child: Container(
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/pattern.png'), // Add this image to your assets
                        ...
                        AnimatedBuilder(
                          ...
                          builder: (context, child) {
                            return Transform.scale(
                              scale: 0.5 + (_logoAnimationController.value * 0.5),
                              child: Opacity(
              ...
              children: [
                ...
                Text(
                  ...
                  style: GoogleFonts.montserrat(
                    fontSize: 24,
                    fontWeight: FontWeight.bold,
                    color: const Color(0xFF1565C0), // Deep blue title for emphasis
                  ),
                ),
              ],
            ),
                ...
                Expanded(
                  child: TextButton.icon(
                    ...
                    style: TextButton.styleFrom(
                      foregroundColor: const Color(0xFF757575), // Gray text for reject
                ...
                Expanded(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      ...
                      backgroundColor: const Color(0xFF1565C0), // Match with title color
                      padding: const EdgeInsets.symmetric(vertical: 12),
                      elevation: 2,
                      shape: RoundedRectangleBorder(
                        borderRadius: BorderRadius.circular(8),
      ...
      children: [
        Row(
          children: [
            ...
            Expanded(
              child: Text(
                title.replaceAll(RegExp(r'🎯|📱|👤|⚠️|🧩'), '').trim(), // Remove emoji from title
                style: GoogleFonts.montserrat(
                  fontSize: 18,
                  fontWeight: FontWeight.bold,
                  color: const Color(0xFF0D47A1), // Darker blue for section titles
                ),
              ),
            ),
          ],
        ...
        const SizedBox(height: 12),
        Padding(
          padding: const EdgeInsets.only(left: 42.0), // Align with text after icon
          child: Text(
            content,
            style: GoogleFonts.poppins(
              fontSize: 14,
              color: const Color(0xFF424242), // Dark gray for better readability
              height: 1.5,
            ),
          ),
        ),
