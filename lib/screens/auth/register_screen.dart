                  ...
                  DropdownSearch<Map<String, dynamic>>(
                    ...
                    items: (String filter, _) async {
                      final res = await http
                          .get(Uri.parse(
                              'http://10.0.2.2:8000/api/municipalities/'))
                    ...
                    selectedItem: _selectedMunicipalityId != null
                        ? {
                            ...
                            'name':
                                '…', // replace with the actual name if you have it
                          }
                        : null,
                    ...
                    decoratorProps: DropDownDecoratorProps(
                      decoration: InputDecoration(
                        ...
                        focusedErrorBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(12.0),
                          borderSide:
                              BorderSide(color: colors.error, width: 2.0),
                        ),
                        filled: true,
                    ...
                    validator: (value) => value == null
                        ? 'Veuillez sélectionner votre municipalité'
                        : null,
                  ),
...
Future<bool> _sendVerificationCode(String phoneNumber, String language) async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      print(
          'Failed to send verification code. Status: ${response.statusCode}, Body: ${response.body}');
      return false;
    }
  } catch (e) {
